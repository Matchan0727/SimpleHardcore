    ...
    init {
        if (Bukkit.getWorld("world") != null) {
            ...
            if (container.get<Int, Int?>(
                    NamespacedKey(SimpleHardcore.Companion.plugin!!, "count"),
    ...
    override fun run() {
        ...
        for (player in Bukkit.getOnlinePlayers()) {
            player.spigot().sendMessage(
                ...
                TextComponent(
                    ChatColor.GOLD.toString() + (SimpleHardcore.Companion.config!!.getInt("worldcount", 1)
